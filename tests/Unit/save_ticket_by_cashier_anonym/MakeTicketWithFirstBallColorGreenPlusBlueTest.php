...
namespace Tests\Unit\save_ticket_by_cashier_anonym;

use Tests\TestCase;
use GuzzleHttp\Client;

class MakeTicketWithFirstBallColorGreenPlusBlueTest extends TestCase
{
    ...
    //save ticket WITH FIRST BALL COLOR GREEN AND BLUE
    public function testSaveTicketInformationWithFirstBallColorGreenPlusBlue(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=11:2,3:1;";
