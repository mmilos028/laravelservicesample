...
class MakeTicketWithFirstNumberEvenTest extends TestCase
{
    ...
    //save ticket WITH FIRST NUMBER EVEN
    public function testSaveTicketInformationWithFirstNumberEven(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=10:2:1;";
