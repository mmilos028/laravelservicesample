...
class MakeTicketWithEvenInFirst5Test extends TestCase
{
    ...
    //save ticket WITH EVEN IN FIRST FIVE TICKETS
    public function testSaveTicketInformationWithEvenInFirst5Test(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=8:2:1;";
