...
class MakeTicketWithFirstBallColorBlueTest extends TestCase
{
    ...
    //save ticket WITH FIRST BALL COLOR BLUE
    public function testSaveTicketInformationWithFirstBallColorBlue(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=11:3:1;";
