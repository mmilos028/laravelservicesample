...
class MakeTicketWithOddInFirst5Test extends TestCase
{
    ...
    //save ticket WITH ODD IN FIRST FIVE TICKETS
    public function testSaveTicketInformationWithOddInFirst5Test(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=8:1:1;";
