...
class MakeTicketWithUnderFiveSumTest extends TestCase
{
    ...
    //save ticket WITH UNDER 5 SUM
    public function testSaveTicketInformationWithUnderFiveSumTest(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=7:2:1;";
