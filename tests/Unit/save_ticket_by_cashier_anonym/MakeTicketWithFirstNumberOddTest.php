...
class MakeTicketWithFirstNumberOddTest extends TestCase
{
    ...
    //save ticket WITH FIRST NUMBER ODD
    public function testSaveTicketInformationWithFirstNumberOdd(){
        $url = getenv('WEB_SERVICE_URL') . '/rest/json';
        $client = new Client(['headers' => [ 'Content-Type' => 'application/json' ]]);

        $combination = "COMB1=10:1:1;";
